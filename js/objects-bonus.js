...
// date,
// office,
// and employees: {employee-number, first-name, last-name, sales-units}
/**
 * problem statement: create a function that prompts the user for the office
 * and to enter the employees. The title will be set and the date will be
 * retrieved using
 */
...
//
// function getEmployeeCount(salesReport) {
...
salesReport.getAverageSalesPerEmployee = function (){
    var numberOfEmployees = this.getEmployeeCount();
    var total = this.getTotalNumberOfSales();
